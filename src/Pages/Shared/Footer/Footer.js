...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-neutral text-neutral-content rounded-none">
            ...
            <div>
                <p>Copyright © 2022 - All right reserved by Lawyer Service Startup Ltd</p>
            </div>
        </footer>
    );
};
